...
function calculateScrollPercentage() {
  ...
  const heightDifference = document.body.clientHeight - window.innerHeight;
  console.log(currentPosition, heightDifference);
  const percentage = (currentPosition / heightDifference) * 100;
  return percentage;
}
